        ...
        <div className='navbarr'> 
            <div className='container'>
                <div className='nav-bottom'>
                    <div>
                        <button className='brand pointer' style={{all: 'unset'}} onClick={() => navigate('/')}><div className='brand-title'><h1>MyStore</h1><div className='dot'></div></div></button>
                    </div>
